...
import com.usrun.core.payload.activity.DeleteActivityRequest;
import com.usrun.core.payload.activity.EditActivityRequest;
  ...
  public ResponseEntity<?> getUserActivityByTimeWithSum(
    ...
    try {
      ...
      List<UserActivity> allByTimeRangeAndUserId = userActivityRepository
          .findAllByTimeRangeAndUserId(timeRequest.getUserId(), timeRequest.getFromTime(),
              timeRequest.getToTime(),
...
//      Love insert = loveRepository.insert(loveObject);
  ...
  public ResponseEntity<?> getStatUser(
    ...
    try {
      long userId = userStatRequest.getUserId();
  ...
  public ResponseEntity<?> editActivity(
    ...
    try {
      Long userId = userPrincipal.getId();
      UserActivity resp = activityService
          .updateActivity(editActivityRequest.getActivityId(), userId,
              editActivityRequest.getTitle(),
